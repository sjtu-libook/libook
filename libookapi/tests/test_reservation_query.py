...
def test_all_reservation_region_group_query():
    ...
    assert response.status_code == 200
    assert response.json() == [
        {'reserved': 2, 'capacity': 150, 'time_id': time1.id, 'region_group_id': group1.id},
        {'reserved': 1, 'capacity': 150, 'time_id': time2.id, 'region_group_id': group1.id},
        {'reserved': 1, 'capacity': 180, 'time_id': time1.id, 'region_group_id': group2.id},
        {'reserved': 1, 'capacity': 180, 'time_id': time2.id, 'region_group_id': group2.id}
    ]